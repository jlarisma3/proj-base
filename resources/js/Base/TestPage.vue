...
import Ticket from "./Mock/Ticket.vue";
import TicketForm from "./Mock/TicketForm.vue";
import TicketDetails from "./Mock/TicketDetails.vue";
import Asset from "./Mock/Asset.vue";
import AssetDetails from "./Mock/AssetDetails.vue";
import AssetForm from "./Mock/AssetForm.vue";

const navigation = [
    { name: 'Dashboard', href: '#', icon: HomeIcon, current: true },
    { name: 'Tickets', href: '#', icon: UsersIcon, current: false },
    { name: 'Asset Management', href: '#', icon: FolderIcon, current: false },
